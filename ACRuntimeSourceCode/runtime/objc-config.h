...
#pragma mark - Alex （这里使用Objc2==1、 使用asm文件提升Objc2的优势）
...
#pragma mark - Alex (OBJC2 ==1 这里 SUPPORT_TAGGED_POINTERS == 1)
...
// Be sure to edit tagged pointer SPI in objc-internal.h as well.
#pragma mark - Alex (OBJC2 -> SUPPORT_TAGGED_POINTERS == 1， TARGET_OS_OSX == 0 && TARGET_OS_IOSMAC == 0; SUPPORT_MSB_TAGGED_POINTERS == 1 )
...
#pragma mark - Alex (__ARM_ARCH_7K__暂未查到；__arm64__: ARM64位处理器； __LP64__: 64处理器下 Long 和 Pointer是64位)
...
#pragma mark - Alex (TARGET_OS_WIN32 在iOS或者OSX中为0 SUPPORT_PACKED_ISA == 1)
...
#pragma mark - Alex (SUPPORT_PACKED_ISA == 1 -> SUPPORT_NONPOINTER_ISA == 1)
