...
/* Alex注释:
    #pragma mark - Define//////////////// 此代码非Runtime源码、
 */
...
#pragma mark - Define////////////////SUPPORT_TAGGED_POINTERS
...
#pragma mark - Define////////////////SUPPORT_INDEXED_ISA
...
/*Alex注释:
 当SUPPORT_NONPOINTER_ISA定义为1时、
        {   在其他平台、由于可能在存储是引发错误、isa存储的不是原始指针(raw pointer)    }
 else
        {   isa存储指针指向Class  };
 */
#pragma mark - Define////////////////SUPPORT_NONPOINTER_ISA
#if SUPPORT_NONPOINTER_ISA
/*Alex注释:
    非win32 或者 非三星 iOS或者OSX系统下有效
 */
inline Class 
objc_object::ISA() 
{
...
/*Alex注释:
     以下是不支持非指针的isa存储、也就是isa存储的就是一个指针。
 */
...
#pragma mark - Define////////////////SUPPORT_RETURN_AUTORELEASE
