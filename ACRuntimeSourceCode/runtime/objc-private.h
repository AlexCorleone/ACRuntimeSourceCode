...
/*Alex注释:
 对象结构体的定义、同时类结构体objc_class继承自objc_object结构体对象
 */
struct objc_object {
private:
    isa_t isa;
...
/*Alex注释:
 objc-runtime-new 是OBJC2.0的实现
 objc-runtime-old 是OBJC早期版本的实现
 */
#if __OBJC2__
